          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="images/meiran_face.png" alt="..." class="img-circle profile_img">
              </div>
                  ...
                  <div class="x_content">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-55">
                        <div class="thumbnail">
                          <div class="image view view-first">
                            <img style="width: 100%; display: block;" src="images/PS4_remoteControl.jpg" alt="image" />
                            <div class="mask">
                              <p>PlayStation game</p>
                              <div class="tools tools-bottom">
                                <a href="#"><i class="fa fa-pencil"></i></a>
                                <a href="#"><i class="fa fa-times"></i></a>
                              </div>
                          ...
                          <div class="caption">
                             <p>Price: <small> 150 Points</small></p>
                            <p>Date: <small> 23.5.18</small></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-55">
                        <div class="thumbnail">
                          <div class="image view view-first">
                            <img style="width: 100%; display: block;" src="images/images.jpg" alt="image" />
                            <div class="mask">
                              <p>Your Text</p>
                              <div class="tools tools-bottom">
                          ...
                          <div class="caption">
                             <p>Price: <small> 300 Points</small></p>
                            <p>Date: <small> 15.5.18</small></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-55">
                        <div class="thumbnail">                      
                          <div class="image view view-first">
                            ...
                            <div class="mask">
                              <p>A new computer</p>
                              <div class="tools tools-bottom"> 
                                <a href="#" alt="Edit"><i class="fa fa-pencil"></i></a>
                                <a href="#" alt="Delete"><i class="fa fa-times"></i></a>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="thumbnail">
                          <div class="image view view-first">
                            <img style="width: 100%; display: block;" src="images/kinder-egg.jpg" alt="image" />
                            <div class="mask">
                              <p>A new computer</p>
                              <div class="tools tools-bottom">
                          ...
                          <div class="caption">
                            ...
                            <p>Price: <small> 20 Points</small></p>
                            <p>Date: <small> 10.5.18</small></p>
                          </div>
                        </div>
                      </div>
